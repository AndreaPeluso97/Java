...
public class WheelOfFortuneWheelPanel extends JPanel {
	...
	private static final String IMAGES_DIR = "C:/Users/Andrea/workspace/RuotaDellaFortuna/resources/images/",
    ...
    public WheelOfFortuneWheelPanel(WheelOfFortuneGame game,
            ...
            WheelOfFortunePuzzlePanel puzzlePanel) throws MalformedURLException {
        super();
        ...
        SPINNING_WHEEL_CLIP =
            Applet.newAudioClip(new URL(
            		"file://"+SOUNDS_DIR + "spinningWheel.wav"));
        GOOD_GUESS_CLIP =
            Applet.newAudioClip(new URL(
            		"file://"+SOUNDS_DIR + "goodGuess.wav"));
        BAD_GUESS_CLIP =
            Applet.newAudioClip(new URL(
            		"file://"+SOUNDS_DIR + "badGuess.wav"));
        BANKRUPT_CLIP =
            Applet.newAudioClip(new URL(
            		"file://"+SOUNDS_DIR + "bankrupt.wav"));
        NO_MORE_VOWELS_CLIP =
            Applet.newAudioClip(new URL(
            		"file://"+SOUNDS_DIR + "noMoreVowels.wav"));
        ...
        for (String imageName : IMAGE_NAMES) {
            IMAGES.put(
                imageName,
                defaultToolkit.getImage(new URL(
                		"file://"+IMAGES_DIR + imageName)));
        }

        IMAGES.put(
            "arrow.png",
            defaultToolkit.getImage(new URL(
            		"file://"+IMAGES_DIR + "arrow.png")));
