...
public class RegisterPanelAdmin extends JPanel{
	...
	private RegisterFrameAdmin registerFrame;
	...
	public RegisterPanelAdmin(RegisterFrameAdmin frame) {
			...
			if(source == enter) {
				try {
					...
					if(emailF.getText() != "" && nicknameF.getText() != "" && nameF.getText() != "") 
						agg = AdminRdF.addUser(emailF.getText() , nameF.getText(), surnameF.getText(), nicknameF.getText());
