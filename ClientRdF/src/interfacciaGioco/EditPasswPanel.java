...
public class EditPasswPanel extends JPanel{
	...
	private EditPasswFrame editPasswFrame;
	...
	public EditPasswPanel(EditPasswFrame frame) {
	...
	private class ButtonListener7 implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			if(source == back) {
				...
				try {
					if(Client.updatePasswordCode(Client.email , String.valueOf(newPasswF.getPassword()), String.valueOf(passwF.getPassword()))) {
						editPasswFrame.dispose();
						new PlayerFrame();
					} else {
						passwF.setText("");
