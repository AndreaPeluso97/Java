...
public class PasswPanel extends JPanel{
	...
	public PasswPanel(PasswFrame frame) {
	...
	private class ButtonListener8 implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			if(source == enter) {
				try {
					Client.updatePasswordCode(Client.email, String.valueOf(passwF.getPassword()), PasswFrame.cod);
					passwFrame.dispose();
					new PlayerFrame();
